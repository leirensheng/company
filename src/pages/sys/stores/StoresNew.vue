<template>
  <el-dialog title="新建门店" v-model="inputs.show" :close-on-click-modal="false" @open="onOpen">
    <el-form :model="dialogForm" label-width="100px" :rules="dialogFormRules" ref="editFormDialog">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="所在区/县：" prop="countyId">
    ...
    methods: {
      ...
      submit() {
        ...
        this.$refs['editFormDialog'].validate((valid) => {
          if (valid) {
            this.$emit('handleUserDialog',{status: 1, data:this.dialogForm, message: '新建成功'});
          }
        })
      }
    }
